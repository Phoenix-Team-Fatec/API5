...
|------|------------|----|------------|--------|--------------------------|
| #1 | Alta | Como proprietário rural, quero entrar no app com minha conta Gov.br para acessar meus imóveis do CAR. | 8 | 1 | RF1 |
| #2 | Alta | Como usuário, quero conseguir entrar no aplicativo sem fazer log-in por conta Gov.br. | 5 | 1 | RF2 |
...
| #8 | Alta | Como usuário, quero registrar condições de vias (tipo, severidade) geo referenciadas para informar a comunidade. | 8 | 2 | RF8 |
...
| #12 | Alta | Como usuário, quero traçar rotas até a minha propriedade considerando condições de vias e alertas para evitar riscos. | 13 | 2 | RF14 |
| #13 | Média | Como usuário, quero receber notificações push quando houver novos alertas ou mudanças relevantes nas vias que sigo. | 5 | 2 | RF12 |
| #14 | Média | Como usuário, quero sinalizar trechos intransitáveis e obter rota alternativa automaticamente. | 8 | 3 | RF15 |
| #15 | Alta | Como Administrador, gostaria de ter um portal para observar logs e gerenciar usuários | 5 | 3 |  |
| #16 | Média | Como administrador, quero revisar/recusar relatos de via para evitar abusos e informações falsas. | 8 | 3 | RF10 |
| #17 | Média | Como usuário, quero registrar relatos offline e sincronizar quando houver conexão para não perder informações. | 8 | 3 |  |
| #18 | Baixa | Como usuário, quero configurar preferências de notificação para evitar alertas indesejados. |  3 | 3 | RF13 |
| #19  | Média | Como usuário, quero poder acessar o serviço pelo servidor da AWS. | 3 | 3 |  |
